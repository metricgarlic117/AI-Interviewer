...
import { getInterview } from '../features/interview/services/interviewApi';
...
export default function ResultPage() {
  ...
  if (!session || !session.feedback)
    return <div className="p-10 text-center text-slate-500">Feedback not found.</div>;
  ...
  const safeField = (value, validList) => {
    ...
    if (validList && !validList.some((v) => value.toLowerCase().includes(v.toLowerCase())))
    ...
    <div className="max-w-6xl mx-auto px-4 py-10 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 flex flex-col items-center justify-center text-center relative overflow-hidden">
          ...
          <div className={`text-3xl font-extrabold mb-1 ${gradeColor.split(' ')[0]}`}>
            {f.overallGrade || '—'}
          </div>
