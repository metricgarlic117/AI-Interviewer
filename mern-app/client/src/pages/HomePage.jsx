  ...
  return (
    <div className="relative min-h-screen bg-slate-50 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
        ...
        >
          Practice with an advanced AI that simulates real technical interviews. Get instant,
          actionable feedback and level up your career.
        </p>
        ...
        >
          <Link
            to="/signup"
            className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-slate-900 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-gray-800 hover:-translate-y-1 shadow-xl hover:shadow-2xl"
          >
            Start for Free
