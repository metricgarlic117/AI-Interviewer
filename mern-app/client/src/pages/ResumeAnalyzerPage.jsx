...
import { InterviewLevel } from '../constants';
import { analyzeResume, extractTextFromImage } from '../features/resume/services/resumeApi';
...
export default function ResumeAnalyzerPage() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      // Analyze + persist in one call; the server also updates prep context.
        ...
        {currentStep === 'upload' && (
          <div className="flex-1 flex flex-col items-center justify-center p-12 text-center animate-slide-up">
            ...
            <p className="text-slate-500 mb-8 max-w-sm">
              We accept PDF files. We'll scan it to extract your skills and experience.
            </p>
        ...
        {currentStep === 'results' && analysisResult && (
          <div className="flex-1 flex flex-col p-8 animate-slide-up overflow-y-auto max-h-[600px] scrollbar-hide">
              ...
              <div className="relative">
                <svg className="w-24 h-24 transform -rotate-90" viewBox="0 0 96 96">
                  ...
                  <circle
                    ...
                    strokeDashoffset={226.2 - (226.2 * analysisResult.matchScore) / 100}
                    strokeLinecap="round"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
                  <i className="fa-solid fa-layer-group text-indigo-500"></i> Skills Analysis
                </h3>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
                  <i className="fa-solid fa-pen-nib text-amber-500"></i> Resume Improvements
                </h3>
            ...
            <div className="bg-slate-50 rounded-xl border border-slate-200 p-6 mb-8">
              <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
                <i className="fa-solid fa-comments text-indigo-500"></i> Likely Interview Topics
              </h3>
